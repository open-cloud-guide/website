...
|   | Code | Governing body | Get started |
| - | - | - | - |
| [Open APIs](https://www.openapis.org)  | N/A | Linux Foundation| [Documentation](https://oai.github.io/Documentation) | 
| [Swagger Editor](https://swagger.io/tools/swagger-editor/)  |  [GitHub repo](https://github.com/swagger-api/swagger-editor) | [Smart Bear](https://smartbear.com) | [Get started](https://editor.swagger.io/) |
| [AsyncAPI Initiative](https://www.asyncapi.com/) | [Async API Playground](https://playground.asyncapi.io/?load=https://raw.githubusercontent.com/asyncapi/asyncapi/v2.1.0/examples/simple.yml) | Linux Foundation| [Documentation](https://www.asyncapi.com/docs/getting-started)|

## API development and management

|   | GitHub repo | Governing body | Get started |
| - | - | - | - |
| [Kong API Gateway](https://konghq.com/)  | [GitHub repo](https://github.com/Kong/kong) | N/A) | [Get started video](https://konghq.com/videos/kong-gateway-for-beginners) |
| [LoopBack](https://loopback.io/) | [GitHub repo](https://github.com/loopbackio/loopback-next) | OpenJS Foundation | [Getting started](https://loopback.io/getting-started.html) |
